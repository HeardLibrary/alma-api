...
exec('/opt/remi/php74/root/usr/bin/php expire_inactive_users.php server=sandbox&infile=vu');
...
exec('/opt/remi/php74/root/usr/bin/php expire_inactive_users.php server=sandbox&infile=vumc');
